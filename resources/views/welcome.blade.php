...
<div class="overflow-x-auto mt-6">
  ...
  <table class="table-auto border-collapse w-full">
      <thead>
        <tr class="rounded-lg text-sm font-medium text-gray-700 text-left" style="font-size: 0.9674rem">
          ...
          <th class="px-4 py-2 bg-gray-200 " style="background-color:#f8f8f8">Auteur</th>
  ...
  @foreach ($films as $film)
        <tr class="hover:bg-gray-100  border-gray-200">
          ...
          <td class="px-4 py-4"><a href="/livre/{{$film->id}}">{{$film->titre}}</a></td>
         

    <td class="px-4 py-4"></a></td>
    <td> 
    <td class="px-4 py-4"><a class="px-6 py-2 text-sm font-semibold rounded-md shadow-md text-sky-100 bg-sky-500 hover:bg-sky-700 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300" </a></td>
    <td> 
       <br>
</td>
